...
- 🚀 **Exploring functional programming** with Clojure and its ecosystem
- 🗄️ **Deep diving into Datomic** for immutable database solutions
- 🏛️ **Mastering architectural patterns** beyond Diplomat Architecture
...
- 🎵 **Music lover** - Always coding with good tunes in the background
...
⭐️ From [thrsouza](https://github.com/thrsouza) with 💜
